...
const DEFAULT_KNOWLEDGE_BASES: KnowledgeBase[] = [
  { id: "kb-1", name: "Project Documentation", type: "folder", path: "./docs", enabled: true },
  { id: "kb-2", name: "API Reference", type: "web", path: "https://platform.openai.com/docs", enabled: false },
  { id: "kb-3", name: "Code Standards", type: "document", path: "./STANDARDS.md", enabled: true },
]
