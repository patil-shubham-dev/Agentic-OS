...
import {
  ...
  Terminal, Wrench, Shield, Zap, type LucideIcon,
} from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <motion.h3
        ...
        className="text-sm font-semibold text-white/70 mb-1 flex items-center gap-2"
      >
        What would you like to do?
        {agentCount !== undefined && agentCount > 0 && (
          <span className="text-[9px] text-white/25 bg-white/[0.04] px-1.5 py-0.5 rounded-full font-normal">
            {agentCount} agents
          </span>
        )}
      </motion.h3>
      ...
      <motion.p
        ...
        className="text-[11px] text-white/30 mb-5 text-center max-w-xs"
      >
        {workspaceName
