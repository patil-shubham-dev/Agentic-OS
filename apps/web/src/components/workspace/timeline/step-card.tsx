...
import { Check, Square, AlertCircle, ChevronDown, ChevronRight, Code, FileText, Terminal, Globe, Loader2, Clock, Brain } from "lucide-react"
...
const STATUS_STYLES = {
  ...
  complete: "border-white/[0.06] bg-gradient-to-b from-white/[0.03] to-white/[0.01]",
  error: "border-red-500/30 bg-gradient-to-b from-red-500/[0.04] to-red-500/[0.01]",
  waiting: "border-white/[0.03] bg-white/[0.01] opacity-60",
} as const
    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between px-3 py-2.5 border-b border-white/[0.06]">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-[11px] font-semibold text-white/70 truncate">{roleName}</span>
      ...
      {hasToolCalls && status === "running" && <LiveToolStream toolCalls={toolCalls} />}
