  ...
  return (
    <div className="flex items-center gap-1 px-3 py-1.5 border-t border-white/[0.04]">
      ...
      {onRetry && (
        <button
          onClick={onRetry}
          className="flex items-center gap-1 rounded-md px-1.5 py-0.5 text-[9px] text-white/25 hover:text-white/50 hover:bg-white/[0.04] transition-all"
        >
      ...
      <button
        ...
        className={cn(
          ...
          rated === "up" ? "text-emerald-400" : "text-white/20 hover:text-white/50 hover:bg-white/[0.04]",
        )}
      >
      ...
      <button
        ...
        className={cn(
          "rounded-md p-0.5 transition-all",
          rated === "down" ? "text-red-400" : "text-white/20 hover:text-white/50 hover:bg-white/[0.04]",
        )}
      >
