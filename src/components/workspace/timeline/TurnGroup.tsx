    ...
    <motion.div
      ...
      className={cn(
        ...
        isLatest
          ...
          : "border-foreground/6 bg-foreground/[0.02]",
      )}
    ...
    >
      ...
      <div
        className={cn(
          ...
          "border-b border-foreground/4 hover:bg-foreground/[0.015] transition-colors",
        )}
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className={cn(
            ...
            collapsed ? "text-foreground/40 line-clamp-1" : "text-foreground/80",
          )}>
            {userEvent.content}
          </p>
        </div>
        ...
        <span className="text-[8px] text-foreground/15 font-mono mt-0.5 shrink-0">{timeStr}</span>
            ...
            >
              ...
              {onRetry && (
                <button
                  ...
                  className="rounded-lg p-1.5 text-foreground/30 hover:text-foreground/60 hover:bg-foreground/[0.06] transition-all"
                  title="Retry with same prompt"
                >
                  <RefreshCw className="h-3 w-3" />
                </button>
              )}
              <div className="flex items-center gap-0.5 ml-1 pl-1 border-l border-foreground/6">
                <button
